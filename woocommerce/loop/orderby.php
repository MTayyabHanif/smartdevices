...
<div class="woocommerce-tab-ordering tabs magic-b">
	<a class="button tab-name <?php echo $popularSelected; ?>" href="<?php  echo $shop_page_url; ?>?orderby=popularity"><?php echo __('Popular Items'); ?></a>
	<a class="button tab-name <?php echo $lowPriceSelected; ?>" href="<?php echo $shop_page_url; ?>?orderby=price"><?php echo __('Low Price'); ?></a>
	<a class="button tab-name <?php echo $highPriceSelected; ?>" href="<?php echo $shop_page_url; ?>?orderby=price-desc"><?php echo __('High Price'); ?></a>
</div>